...
@Serializable data class Integer(
  ...
  @ProtoNumber(5) val fixedUnsignedInt32: UInt = 0U,
  @ProtoNumber(6) val fixedUnsignedInt64: ULong = 0UL,
  @ProtoNumber(7) val zigzagSignedInt32: Int = 0,
  @ProtoNumber(8) val zigzagSignedInt64: Long = 0L,
) {
  override fun equals(other: Any?): Boolean {
    if (this === other) return true
    if (javaClass != other?.javaClass) return false
...
@Serializable data class Sequence(
  @ProtoNumber(1) val bytesSequence: ByteArray = byteArrayOf(),
